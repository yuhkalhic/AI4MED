...
export MCBLAS_CUSTOMIZED_CONFIG_PATH=/workspace/LLaMA-Factory-main/examples/lora_multi_gpu/lib/qwen1.5-72b/mcblas_customized_config.yaml
...
llamafactory-cli train qwen1.5-72b_lora_pretrain.yaml
