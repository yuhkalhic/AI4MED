...
export MCBLAS_CUSTOMIZED_CONFIG_PATH=/workspace/LLaMA-Factory-main/examples/lora_multi_gpu/lib/llama3-70b/mcblas_customized_config.yaml
...
llamafactory-cli train llama3_70b_instruct_lora_pretrain.yaml
